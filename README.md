...
| --- | --- |
| You already have the Moda MCP connected, or only want the REST-API skill | **Vercel `skills` CLI** — `npx skills add nullframe/moda-skills` (skills only, no MCP touch) |
...
```bash
claude /plugin marketplace add nullframe/moda-skills
...
```bash
npx skills add nullframe/moda-skills -a claude-code
```
...
```bash
npx skills add nullframe/moda-skills --skill moda-mcp -a claude-code
npx skills add nullframe/moda-skills --skill moda-api -a claude-code
```

### Cursor — plugin

```
/add-plugin nullframe/moda-skills
```
...
```bash
npx skills add nullframe/moda-skills -a cursor
```
...
3. For skill docs in your coding environment, run `npx skills add nullframe/moda-skills` there.
...
```bash
npx skills add nullframe/moda-skills -a vscode
```

### Gemini CLI

```bash
gemini extensions install https://github.com/nullframe/moda-skills
...
- Run `npx skills add nullframe/moda-skills -a <agent>` (the CLI supports 45+ agents).
...
- Confirm install target: `npx skills add nullframe/moda-skills --list` shows both skills.
...
File issues at [github.com/nullframe/moda-skills/issues](https://github.com/nullframe/moda-skills/issues). Product feedback on Moda itself goes to [support@moda.app](mailto:support@moda.app).
